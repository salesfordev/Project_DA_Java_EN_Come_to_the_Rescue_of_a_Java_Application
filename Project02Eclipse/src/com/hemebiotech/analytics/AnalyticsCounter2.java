...
public class AnalyticsCounter2 {
	 ...
	 * @throws Exception - An exception can be raised if there is a read or write
	 *                   error in the file.
	 */
	public static void main(String args[]) throws Exception {
		...
		try {
			List<String> symptoms = reader.readSymptomData("Project02Eclipse/symptoms.txt"); // Reading the symptoms
																								// from the file.
			...
			System.out.println("Aucune erreur n'a été générée lors du traitement des données.");
			System.out.println();
			System.out.println("###################################################################");
		}
